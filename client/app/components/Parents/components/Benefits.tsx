...
const Benefits = () => {
  ...
  return (
    <Section id="features" className="overflow-hidden py-16 lg:py-24">
      <div className="container relative z-2 px-4 sm:px-6 lg:px-8">
        ...
        >
          <Heading
            ...
            title={
              locale === "ar" ? "اقرأ المزيد..." : `${parents.blogTitle} ...`
            }
            text={
              locale === "ar"
                ? "اكتشف مقالاتنا التعليمية المتنوعة حول البرمجة والتكنولوجيا للأطفال"
                : "Discover our diverse educational articles about programming and technology for children"
            }
          />
        </motion.div>
        ...
        >
          {parents.blogs.map((item, index) => (
            <motion.div
              ...
              animate="visible"
              whileHover="hover"
              className="card relative p-0.5 bg-no-repeat bg-[length:100%_100%] w-full max-w-[24rem] group"
              style={{
                backgroundImage: `url(${image.src})`,
              }}
            >
              <div className="relative z-2 flex flex-col min-h-[24rem] p-6 sm:p-[2.4rem] bg-n-8 rounded-xl group-hover:shadow-2xl transition-shadow duration-300">
                <h5
                ...
                >
                  ...
                  <Link
                    ...
                    className={`${isRTL ? "mr-auto" : "ml-auto"} font-code text-xs font-bold text-n-1 uppercase tracking-wider hover:text-[#b886f2] transition-colors flex items-center gap-2 group-hover:gap-3 transition-all duration-300`}
              ...
              {/* Enhanced gradient overlay for Parents theme */}
              <div className="absolute inset-0 bg-gradient-to-br from-[#b886f2]/5 to-[#ed82c3]/5 rounded-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none" />
            </motion.div>
          ))}
        </motion.div>
        ...
        >
          <Link
            href="/blogs"
            className="inline-flex items-center gap-2 px-8 py-3 bg-gradient-to-r from-[#b886f2] to-[#ed82c3] text-white font-semibold rounded-lg hover:shadow-lg hover:scale-105 transition-all duration-300"
          >
      ...
      {/* Enhanced styles for Parents Benefits */}
      <style jsx>{`
        .line-clamp-4 {
          display: -webkit-box;
          -webkit-line-clamp: 4;
        ...
        .card::before {
          ...
          background: linear-gradient(
            135deg,
            rgba(184, 134, 242, 0.1) 0%,
            rgba(237, 130, 195, 0.1) 100%
          );
          opacity: 0;
