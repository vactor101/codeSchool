  ...
  return (
    <div className="relative w-full h-full">
      <Swiper
        ...
        allowTouchMove={true}
      >
        {parents.slidersImages.map((slider, index) => (
          <SwiperSlide key={index} className="relative">
            <div className="relative w-full h-full bg-gradient-to-br from-purple-900/20 to-pink-900/20">
              ...
              {!loadedImages.has(index) && !imageErrors.has(index) && (
                <div className="absolute inset-0 flex items-center justify-center bg-gradient-to-br from-purple-100 to-pink-100 dark:from-purple-900/50 dark:to-pink-900/50">
              ...
              <Image
                ...
                `}
                fill
                alt={`Code School Hero Image ${index + 1}`}
      ...
      <div className="absolute bottom-4 left-1/2 transform -translate-x-1/2 z-20 flex space-x-2">
        {parents.slidersImages.map((_, index) => (
          <div
            key={index}
